...
(function () {
  ...
  // only the one that actually owns 000-000-0000 delivers; the rest quietly drop.
  ...
  var SEED_KIT = [
    ...
    { id: 'flyer5', theme: 'blue', tag: 'Book Today', title: 'Take the first step', headline: 'A caring team is ready to listen', sub: 'Call or text 000-000-0000, or request an appointment online.' },
